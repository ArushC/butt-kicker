...
const knex = require('../knex'); // Adjust the path to your knex instance
...
router.post('/:id', async (req, res) => {
    ...
    try {
      // Call updateState and get the currentStreak and user
      ...
      if (typeof smoke_free_today !== 'undefined') {
        //if (Boolean(user.smoke_free_today) !== smoke_free_today) {
